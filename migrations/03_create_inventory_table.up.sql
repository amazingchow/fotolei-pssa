CREATE TABLE IF NOT EXISTS fotolei_pssa.inventories (
    ...
    st_inventory_qty           INT,          DEFAULT 0   /* 起始库存数量 */
    st_inventory_total         FLOAT,        DEFAULT 0.0 /* 起始库存总额 */
    purchase_qty               INT,          DEFAULT 0   /* 采购数量 */
    purchase_total             FLOAT,        DEFAULT 0.0 /* 采购总额 */
    purchase_then_return_qty   INT,          DEFAULT 0   /* 采购退货数量 */
    purchase_then_return_total FLOAT,        DEFAULT 0.0 /* 采购退货总额 */
    sale_qty                   INT,          DEFAULT 0   /* 销售数量 */
    sale_total                 FLOAT,        DEFAULT 0.0 /* 销售总额 */
    sale_then_return_qty       INT,          DEFAULT 0   /* 销售退货数量 */
    sale_then_return_total     FLOAT,        DEFAULT 0.0 /* 销售退货总额 */
    others_qty                 INT,          DEFAULT 0   /* 其他变更数量 */
    others_total               FLOAT,        DEFAULT 0.0 /* 其他变更总额 */
    ed_inventory_qty           INT,          DEFAULT 0   /* 截止库存数量 */
    ed_inventory_total         FLOAT,        DEFAULT 0.0 /* 截止库存总额 */
    ...
    anchor                     TINYINT,      DEFAULT 0   /* 锚，防止‘组合商品‘读出来带空格 */
    PRIMARY KEY (id),
