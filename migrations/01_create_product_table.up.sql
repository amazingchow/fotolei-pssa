CREATE TABLE IF NOT EXISTS fotolei_pssa.products (
    ...
    product_weight     FLOAT,        DEFAULT 0.0 /* 重量/g */
    product_length     FLOAT,        DEFAULT 0.0 /* 长度/cm */
    product_width      FLOAT,        DEFAULT 0.0 /* 宽度/cm */
    product_height     FLOAT,        DEFAULT 0.0 /* 高度/cm */
    ...
    jit_inventory      INT,          DEFAULT 0   /* 实时可用库存 */
    moq                INT,          DEFAULT 0   /* 最小订货单元 */
